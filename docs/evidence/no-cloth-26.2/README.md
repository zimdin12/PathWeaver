...
Measured 2026-09-12 at commit `ac68108`, on a clean Fabric 26.2 server (loader 0.19.5) built from
...
| `2-pathweaver-no-cloth-STARTS.log` | + PathWeaver 0.9.0+26.2 | starts, `PathWeaver is ACTIVE: all 6 movement families can path off-thread`, `Done (0.386s)` |
