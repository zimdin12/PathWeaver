...
23 of 23 witnessed and 476 tests became 33 of 33 and 509, and after the hot-path fixes 36 of 36 and 515.
...
And a third time. Measuring LOD, preregistered, found it dropping the refreshes it was meant to
delay. That is fixed and measured again: `docs/evidence/lod-fixed-2026-09-13/` on the master branch.
