...
VERSION = "0.7.0"
PID = "ZQJOU3vB"
TITLE = "0.7.0 - Fewer wrong answers, fewer hiding places"
PREVIOUS = "0.6.1"
DRY = os.environ.get("PATHWEAVER_DRY_RUN") == "1"

# (worktree, expected commit, jar, game versions for this file)
ARTIFACTS = [
    ("../pw-070", "af5f8bcb20b3c03107f136bb4445d8236df7c029",
     "build/libs/pathweaver-0.7.0+26.1.2.jar", ["26.1.1", "26.1.2"], "26.1.2"),
    ("../pw-070-262", "8696df5a0ba8f072fd505725f3ff07485e43ec79",
     "build/libs/pathweaver-0.7.0+26.2.jar", ["26.2"], "26.2"),
]
...
changelog = open("release/changelog-0.7.0.md", encoding="utf-8").read()
body = open("release/body-0.7.0.md", encoding="utf-8").read()
